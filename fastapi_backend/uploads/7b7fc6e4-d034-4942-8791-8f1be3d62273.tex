...
\author{Renat Sergazinov ${ }^{1}{ }^{*}$ Elizabeth Chun ${ }^{1}$, Valeriya Rogovchenko ${ }^{1}$, Nathaniel Fernandes ${ }^{2}$, Nicholas Kasman ${ }^{2}$, Irina Gaynanova ${ }^{1 *}$\\
...
\begin{figure}[h]
\begin{center}
  \includegraphics[width=\textwidth]{2025_10_06_a6e634cea56277999258g-05}
\captionsetup{labelformat=empty}
